...
public class TinyDB {
    ...
    public ArrayList<Tour> getListObject(String key){
    	Gson gson = new Gson();

    	ArrayList<String> objStrings = getListString(key);
    	ArrayList<Tour> objects =  new ArrayList<>();

    	for(String jObjString : objStrings){
    		Tour value  = gson.fromJson(jObjString,  Tour.class);
    		objects.add(value);
    	}
    	return objects;
    }
...
//    }
//
    public void putListObject(String key, ArrayList<Tour> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
    	ArrayList<String> objStrings = new ArrayList<String>();
    	for(Tour obj : objArray){
